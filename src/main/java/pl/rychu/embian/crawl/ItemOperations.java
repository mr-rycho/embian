...
public class ItemOperations {
	...
	public ItemOperations(String itemId, String itemPath, Collection<ItemOperation> ops) {
		this.itemId = itemId;
	...
	public String toString() {
		return "ItemOperations{" + "itemId='" + itemId + '\'' + ", itemPath='" + itemPath + '\'' + ", operations=" + operations + '}';
	}
